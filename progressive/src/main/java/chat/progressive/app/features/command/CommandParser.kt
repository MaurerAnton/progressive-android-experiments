        ...
        return if (!message.startsWith("/")) {
            ...
            when {
                ...
                Command.LLM.matches(slashCommand) || Command.LLMP.matches(slashCommand) ||
                        ...
                        Command.HIDE_EMOJI.matches(slashCommand) || Command.SMSAGENT.matches(slashCommand) || Command.SCHEDULE.matches(slashCommand) || Command.TRANSLATE.matches(slashCommand) || Command.WEATHER.matches(slashCommand) || Command.REMIND.matches(slashCommand) || Command.STATS.matches(slashCommand) || Command.PIN.matches(slashCommand) || Command.UNPIN.matches(slashCommand) || Command.MENTION.matches(slashCommand) -> {
                    val cmd = listOf(Command.LLM, Command.LLMP, Command.AGENT, Command.WEB, Command.HIDE_EMOJI, Command.SMSAGENT, Command.SCHEDULE, Command.TRANSLATE, Command.WEATHER, Command.REMIND, Command.STATS, Command.PIN, Command.UNPIN, Command.MENTION)
